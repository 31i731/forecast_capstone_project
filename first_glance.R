...
building_2_weekly_ts = ts(building_2_weekly[, "weekly_avg"], frequency = 365.25/7, start = c(2016,8))
autoplot(building_2_weekly_ts)
autoplot(decompose(building_2_weekly_ts, type="additive"))
#autoplot(decompose(energy_produced - decompose(energy_produced)$seasonal))

building_5_weekly_ts = ts(building_5_weekly[, "weekly_avg"], frequency = 365.25/7, start = c(2016,8))
autoplot(building_5_weekly_ts)
autoplot(decompose(building_5_weekly_ts, type="additive"))
#autoplot(decompose(energy_produced - decompose(energy_produced)$seasonal))

building_8_weekly_ts = ts(building_8_weekly[, "weekly_avg"], frequency = 365.25/7, start = c(2016,8))
